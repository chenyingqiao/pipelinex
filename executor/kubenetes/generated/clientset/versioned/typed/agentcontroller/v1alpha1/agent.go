...
import (
	...
	scheme "github.com/chenyingqiao/pipelinex/executor/kubenetes/generated/clientset/versioned/scheme"
...
func newAgents(c *AgentcontrollerV1alpha1Client, namespace string) *agents {
	return &agents{
		client: c.RESTClient(),
		ns:     namespace,
	}
